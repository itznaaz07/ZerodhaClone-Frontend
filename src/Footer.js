    ...
    return ( 
        ...
        <div className='container border-top mt-5' >
            <div className='row mt-5'>
                <div className='col-3'>
                     <img src="media/images/logo.svg" alt="Logo" style={{width:'55%'}}/>
                    <p className='mt-3 text-muted mt-4 mb-4'>© 2010 - 2025, Zerodha Broking Ltd.<br/>All rights reserved.</p>
             <div className="mt-4 d-flex gap-3  text-muted" style={{fontSize:'10px'}}>
