...
function CreateTicket() {
    return (
        <div className="container ">
          ...
          <div className='row'>
          <div className="col-4  p-3 mb-5 mt-3">
            <h5 className="fs-4 mb-3 ">
           <i class="fa fa-plus-circle" aria-hidden="true" style={{marginRight:'10px'}}></i>Account Opening
            </h5>
          ...
          <div className="col-4 p-3 mb-5 mt-3 ">
            <h5 className="fs-4 mb-3">
          <i class="fa fa-user" aria-hidden="true" style={{marginRight:'10px'}}></i>Your Zerodha Account </h5>
          ...
          <div className="col-4 p-3 mb-5 mt-3 ">
            <h5 className="fs-4 mb-3">
          <i class="fa-solid fa-chart-bar" style={{marginRight:'10px'}}></i>Your Zerodha Account </h5>
            <a href='' style={{textDecoration:'none', lineHeight:'2.5'}}>Margin/levarage, product and order types</a><br/>
          ...
          <div className="col-4  p-3 mb-5 mt-3">
            <h5 className="fs-4 mb-3 ">
           <i class="fa-solid fa-indian-rupee-sign" style={{marginRight:'10px'}}></i>Funds
            </h5>
          ...
          <div className="col-4 p-3 mb-5 mt-3 ">
            <h5 className="fs-4 mb-3">
          <i class="fa-solid fa-circle-notch" style={{marginRight:'10px'}}></i>Console </h5>
            ...
            <a href='' style={{textDecoration:'none', lineHeight:'2.5'}}>60 Day Challeng</a><br/>
          ...
          <div className="col-4 p-3 mb-5 mt-3 ">
            <h5 className="fs-4 mb-3">
          <i class="fa-regular fa-circle" style={{marginRight:'10px'}}></i>Coin</h5>
